...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("bitStream_dout", 8, hls_in, 2, "ap_fifo", "fifo_data", 1),
	Port_Property("bitStream_empty_n", 1, hls_in, 2, "ap_fifo", "fifo_status", 1),
	Port_Property("bitStream_read", 1, hls_out, 2, "ap_fifo", "fifo_update", 1),
	Port_Property("bitOut_din", 32, hls_out, 3, "ap_fifo", "fifo_data", 1),
	Port_Property("bitOut_full_n", 1, hls_in, 3, "ap_fifo", "fifo_status", 1),
	Port_Property("bitOut_write", 1, hls_out, 3, "ap_fifo", "fifo_update", 1),
	Port_Property("initd", 128, hls_in, 4, "ap_none", "in_data", 1),
