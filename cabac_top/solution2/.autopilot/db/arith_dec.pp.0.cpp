...
# 3 "src/arith_dec.cpp" 2
# 1 "src/init_tables.h" 1
# 10 "src/init_tables.h"
static const UChar
INIT_SAO_MERGE_FLAG[NUMBER_OF_SLICE_TYPES][1] =
{
  { 153, },
  { 153, },
  { 153, },
...
static const UChar
INIT_SAO_TYPE_IDX[NUMBER_OF_SLICE_TYPES][1] =
{
  { 160, },
  { 185, },
  { 200, },
...
static const UChar
INIT_SPLIT_FLAG[NUMBER_OF_SLICE_TYPES][3] =
{
  { 107, 139, 126, },
  { 107, 139, 126, },
  { 139, 141, 157, },
...
# 4 "src/arith_dec.cpp" 2

void ArithDec::init(UChar* bStream, arith_t& state){
...
void decode_regular(arith_t& state, bool& binVal, UChar* bStream, UInt ctxAddr, UChar ctxTables[512]){
 ...
 UInt val;
 VITIS_LOOP_53_1: while (state.ivlCurrRange < 256) {
