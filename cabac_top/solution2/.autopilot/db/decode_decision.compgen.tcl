...
set ID 38
set hasByteEnable 0
set MemName cabac_top_decode_decision_lpsTable_ROM_AUTO_1R
...
set ID 39
set hasByteEnable 0
set MemName cabac_top_decode_decision_transMPS_ROM_AUTO_1R
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 7
set AddrRange 128
...
set ID 40
set hasByteEnable 0
set MemName cabac_top_decode_decision_transLPS_ROM_AUTO_1R
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 7
set AddrRange 128
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_init_offset \
    op interface \
    ports { init_offset { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mode_offset \
    op interface \
    ports { mode_offset { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 43 \
    name state_ivlCurrRange_V_read \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_state_ivlCurrRange_V_read \
    op interface \
    ports { state_ivlCurrRange_V_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 44 \
    name state_ivlOffset_V_read \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_state_ivlOffset_V_read \
    op interface \
    ports { state_ivlOffset_V_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 45 \
    name state_bstate_currIdx_read \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_state_bstate_currIdx_read \
    op interface \
    ports { state_bstate_currIdx_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 46 \
    name state_bstate_n_bits_held_read \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_state_bstate_n_bits_held_read \
    op interface \
    ports { state_bstate_n_bits_held_read { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 47 \
    name state_bstate_held_aligned_word_read \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_state_bstate_held_aligned_word_read \
    op interface \
    ports { state_bstate_held_aligned_word_read { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bStream1 \
    op interface \
    ports { bStream1 { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_ctxAddr_offset \
    op interface \
    ports { ctxAddr_offset { I 1 vector } } \
} "
}
