set moduleName cabac_top_Pipeline_VITIS_LOOP_13_1
set isTopModule 0
...
set C_modelName {cabac_top_Pipeline_VITIS_LOOP_13_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ ctx int 8 regular {axi_master 1}  }
	{ globalCtx int 64 regular  }
	{ ctxWritten int 10 regular  }
	{ ctxTables int 8 regular {array 512 { 1 3 } 1 1 }  }
	{ empty int 10 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ctx", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "globalCtx","offset": { "type": "dynamic","port_name": "globalCtx","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "ctxTables", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ctxWritten sc_in sc_lv 10 signal 2 } 
	{ ctxTables_address0 sc_out sc_lv 9 signal 3 } 
	{ ctxTables_ce0 sc_out sc_logic 1 signal 3 } 
	{ ctxTables_q0 sc_in sc_lv 8 signal 3 } 
	{ empty sc_in sc_lv 10 signal 4 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "75", "Max" : "582"}
	, {"Name" : "Interval", "Min" : "75", "Max" : "582"}
]}
...
set Spec2ImplPortList { 
	...
	ctxTables { ap_memory {  { ctxTables_address0 mem_address 1 9 }  { ctxTables_ce0 mem_ce 1 1 }  { ctxTables_q0 mem_dout 0 8 } } }
