...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename ctxTables \
    op interface \
    ports { ctxTables_address0 { O 9 vector } ctxTables_ce0 { O 1 bit } ctxTables_we0 { O 1 bit } ctxTables_d0 { O 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { streamCtxRAM_dout { I 8 vector } streamCtxRAM_empty_n { I 1 bit } streamCtxRAM_read { O 1 bit } } \
} "
}
