...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/akhilkushe/Xilinx/Vitis_HLS/2021.2/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/akhilkushe/Xilinx/Vitis_HLS/2021.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/akhilkushe/Xilinx/Vitis_HLS/2021.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/akhilkushe/Xilinx/Vitis_HLS/2021.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "cabac_top.autotvin.dat"
	set constFileTvOut       "cabac_top.autotvout.dat"
	set constFileHdlTvIn     "cabac_top.autohdltvin.dat"
	set constFileHdlTvOut    "cabac_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
