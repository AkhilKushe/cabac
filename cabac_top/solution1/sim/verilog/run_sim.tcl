...
if {[file isfile cabac_top.autotvin.dat]} {
	file delete -force cabac_top.autotvin.dat
}

if {[file isfile cabac_top.autotvout.dat]} {
	file delete -force cabac_top.autotvout.dat
}
