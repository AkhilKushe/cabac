...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.cabac_top.autotvin_ctx.dat"
         "c.cabac_top.autotvin_globalCtx.dat"
         "c.cabac_top.autotvin_bitStream.dat"
         "c.cabac_top.autotvin_data_in_s.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.cabac_top.autotvout_ctx.dat"
         "rtl.cabac_top.autotvout_data_out_s.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
