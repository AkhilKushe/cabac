...
module cabac_top_cabac_top_Pipeline_VITIS_LOOP_14_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] i_8_cast_fu_145_p1;
wire    ap_block_pp0_stage0_01001;
reg   [9:0] i_fu_64;
wire   [9:0] add_ln14_fu_139_p2;
reg   [69:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((~((m_axi_ctx_AWREADY == 1'b0) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_64 <= 10'd0;
    end else if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln14_fu_134_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((icmp_ln14_fu_134_p2 == 1'd1)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln14_fu_134_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone)) & ~((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln14_fu_134_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone)) | ((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
assign add_ln14_fu_139_p2 = (i_fu_64 + 10'd1);
...
assign ctxTables_address0 = i_8_cast_fu_145_p1;

assign i_8_cast_fu_145_p1 = i_fu_64;

assign icmp_ln14_fu_134_p2 = ((i_fu_64 == ctxWritten) ? 1'b1 : 1'b0);
...
endmodule //cabac_top_cabac_top_Pipeline_VITIS_LOOP_14_1
