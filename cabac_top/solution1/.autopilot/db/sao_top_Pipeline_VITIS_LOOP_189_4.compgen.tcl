...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { sao_offset_sign_address0 { O 4 vector } sao_offset_sign_ce0 { O 1 bit } sao_offset_sign_q0 { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { out_SaoOffsetVal_address0 { O 4 vector } out_SaoOffsetVal_ce0 { O 1 bit } out_SaoOffsetVal_we0 { O 1 bit } out_SaoOffsetVal_d0 { O 16 vector } } \
} "
} else {
