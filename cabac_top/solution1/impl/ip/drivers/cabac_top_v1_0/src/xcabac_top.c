...
void XCabac_top_Set_initd(XCabac_top *InstancePtr, XCabac_top_Initd Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XCabac_top_WriteReg(InstancePtr->Control_BaseAddress, XCABAC_TOP_CONTROL_ADDR_INITD_DATA + 0, Data.word_0);
    XCabac_top_WriteReg(InstancePtr->Control_BaseAddress, XCABAC_TOP_CONTROL_ADDR_INITD_DATA + 4, Data.word_1);
    XCabac_top_WriteReg(InstancePtr->Control_BaseAddress, XCABAC_TOP_CONTROL_ADDR_INITD_DATA + 8, Data.word_2);
    XCabac_top_WriteReg(InstancePtr->Control_BaseAddress, XCABAC_TOP_CONTROL_ADDR_INITD_DATA + 12, Data.word_3);
}

XCabac_top_Initd XCabac_top_Get_initd(XCabac_top *InstancePtr) {
    XCabac_top_Initd Data;

    Data.word_0 = XCabac_top_ReadReg(InstancePtr->Control_BaseAddress, XCABAC_TOP_CONTROL_ADDR_INITD_DATA + 0);
    Data.word_1 = XCabac_top_ReadReg(InstancePtr->Control_BaseAddress, XCABAC_TOP_CONTROL_ADDR_INITD_DATA + 4);
    Data.word_2 = XCabac_top_ReadReg(InstancePtr->Control_BaseAddress, XCABAC_TOP_CONTROL_ADDR_INITD_DATA + 8);
    Data.word_3 = XCabac_top_ReadReg(InstancePtr->Control_BaseAddress, XCABAC_TOP_CONTROL_ADDR_INITD_DATA + 12);
    return Data;
}
