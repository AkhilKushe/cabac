...
set Library     "hls"
set IPName      "cabac_top"
set Version     "1.0"
set DisplayName "Cabac_top"
set Revision    "2112964433"
...
set xo_kernel_name "cabac_top"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/akhilkushe/Desktop/Projects/final_year_project/hls_cabac/cabac_top/solution1"
set debug_dir "/home/akhilkushe/Desktop/Projects/final_year_project/hls_cabac/cabac_top/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {cabac_top_mul_7s_6ns_13_1_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 3 RESERVED_0 R 0 {Reserved.  0s on read.}} {5 1 CHAN2_INT_EN RW 0 {Enable Channel 2 (ap_local_deadlock) Interrupt.  0 = Disabled, 1 = Enabled.}} {6 26 RESERVED_1 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup}} {2 3 RESERVED_0 R 0 {Reserved.  0s on read.}} {5 1 CHAN2_INT_ST RTOW 0 {Channel 2 (ap_local_deadlock) Interrupt Status. 0 = No Channel 2 input interrupt, 1 = Channel 2 input interrup}} {6 26 RESERVED_1 R 0 {Reserved.  0s on read.}}}} {0x10 globalCtx_1 W 0x0 "Data signal of globalCtx" {{0 32 globalCtx W 0 "Bit 31 to 0 of globalCtx"}}} {0x14 globalCtx_2 W 0x0 "Data signal of globalCtx" {{0 32 globalCtx W 0 "Bit 63 to 32 of globalCtx"}}} {0x1c initd_1 W 0x0 "Data signal of initd" {{0 32 initd W 0 "Bit 31 to 0 of initd"}}} {0x20 initd_2 W 0x0 "Data signal of initd" {{0 32 initd W 0 "Bit 63 to 32 of initd"}}} {0x24 initd_3 W 0x0 "Data signal of initd" {{0 32 initd W 0 "Bit 95 to 64 of initd"}}} {0x28 initd_4 W 0x0 "Data signal of initd" {{0 32 initd W 0 "Bit 127 to 96 of initd"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_ctx bitStream bitOut"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_ctx {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_ctx"
        data_width "32"
        param_prefix "C_M_AXI_CTX"
...
source -notrace "/home/akhilkushe/Xilinx/Vitis_HLS/2021.2/common/scripts/ipxhls.tcl"
