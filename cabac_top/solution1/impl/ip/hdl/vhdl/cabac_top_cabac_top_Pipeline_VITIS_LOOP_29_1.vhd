...
entity cabac_top_cabac_top_Pipeline_VITIS_LOOP_29_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cabac_top_cabac_top_Pipeline_VITIS_LOOP_29_1 is 
...
attribute shreg_extract : string;
    ...
    signal val_reg_135 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal icmp_ln29_fu_102_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_pp0_exit_iter0_state71 : STD_LOGIC;
    signal i_fu_58 : STD_LOGIC_VECTOR (9 downto 0);
    signal add_ln29_fu_108_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (m_axi_ctx_ARREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                i_fu_58 <= ap_const_lv10_0;
            elsif (((icmp_ln29_fu_102_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                i_fu_58 <= add_ln29_fu_108_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                val_reg_135 <= m_axi_ctx_RDATA;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, m_axi_ctx_ARREADY, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln29_fu_102_p2)
    begin
        case ap_CS_fsm is
    ...
    add_ln29_fu_108_p2 <= std_logic_vector(unsigned(i_fu_58) + unsigned(ap_const_lv10_1));
    ...
    ap_ST_fsm_state1_blk_assign_proc : process(ap_start, m_axi_ctx_ARREADY)
    begin
        if (((ap_start = ap_const_logic_0) or (m_axi_ctx_ARREADY = ap_const_logic_0))) then 
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(m_axi_ctx_RVALID, streamCtxRAM_full_n, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (streamCtxRAM_full_n = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_ctx_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_ctx_RVALID, streamCtxRAM_full_n, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (streamCtxRAM_full_n = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_ctx_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_ctx_RVALID, streamCtxRAM_full_n, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (streamCtxRAM_full_n = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_ctx_RVALID = ap_const_logic_0)));
    end process;

        ap_block_state71_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state72_pp0_stage0_iter1_assign_proc : process(m_axi_ctx_RVALID)
    begin
                ap_block_state72_pp0_stage0_iter1 <= (m_axi_ctx_RVALID = ap_const_logic_0);
    end process;


    ap_block_state73_pp0_stage0_iter2_assign_proc : process(streamCtxRAM_full_n)
    begin
                ap_block_state73_pp0_stage0_iter2 <= (streamCtxRAM_full_n = ap_const_logic_0);
    end process;


    ap_condition_pp0_exit_iter0_state71_assign_proc : process(icmp_ln29_fu_102_p2)
    begin
        if ((icmp_ln29_fu_102_p2 = ap_const_lv1_1)) then 
    ...
    ctx_blk_n_AR_assign_proc : process(ap_start, ap_CS_fsm_state1, m_axi_ctx_ARREADY)
    begin
    ...
    ctx_blk_n_R_assign_proc : process(m_axi_ctx_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0)
    begin
    ...
    icmp_ln29_fu_102_p2 <= "1" when (i_fu_58 = ap_const_lv10_200) else "0";
    m_axi_ctx_ARADDR <= globalCtx;
    m_axi_ctx_ARBURST <= ap_const_lv2_0;
    m_axi_ctx_ARCACHE <= ap_const_lv4_0;
    m_axi_ctx_ARID <= ap_const_lv1_0;
    m_axi_ctx_ARLEN <= ap_const_lv32_200;
    ...
    m_axi_ctx_ARVALID_assign_proc : process(ap_start, ap_CS_fsm_state1, m_axi_ctx_ARREADY)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (m_axi_ctx_ARREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    m_axi_ctx_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    m_axi_ctx_WDATA <= ap_const_lv8_0;
    m_axi_ctx_WID <= ap_const_lv1_0;
    m_axi_ctx_WLAST <= ap_const_logic_0;
    m_axi_ctx_WSTRB <= ap_const_lv1_0;
    m_axi_ctx_WUSER <= ap_const_lv1_0;
    m_axi_ctx_WVALID <= ap_const_logic_0;

    streamCtxRAM_blk_n_assign_proc : process(streamCtxRAM_full_n, ap_block_pp0_stage0, ap_enable_reg_pp0_iter2)
    begin
    ...
    streamCtxRAM_din <= val_reg_135;

    streamCtxRAM_write_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
